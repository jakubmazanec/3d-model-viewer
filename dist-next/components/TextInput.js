...
let TextInput = function (_ash$Component) {
	...
	function TextInput() {
		...
		return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(TextInput).call(this, ...args)), _this), _this.state = {
	...
	(0, _createClass3.default)(TextInput, [{
		...
		value: function render() {
			...
			let textInput = _ash2.default.createElement('input', textInputProps);
