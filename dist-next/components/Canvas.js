...
let Canvas = function (_ash$Component) {
	...
	(0, _createClass3.default)(Canvas, [{
		...
		value: function onMount() {
			...
			let domNodeWidth = _getDomNodeSize.width;
			let domNodeHeight = _getDomNodeSize.height;
			...
			// create camera
			let camera = new _three2.default.PerspectiveCamera(45, domNodeWidth / domNodeHeight, 1, 10000);
			...
			// create axis
			let axisHelper = new _three2.default.AxisHelper(100);
		...
		value: function handleAnimationFrame() {
			...
			let models = _modelsStream2.default.value;
		...
		value: function handleWindowResize() {
			...
			let domNodeWidth = _getDomNodeSize2.width;
			let domNodeHeight = _getDomNodeSize2.height;
		...
		value: function handleMouseMove(event) {
			...
			let intersects = this.raycaster.intersectObjects(_modelsStream2.default.value);
